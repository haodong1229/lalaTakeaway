...
//修改mc_card表background字段长度
if (pdo_fieldexists('mc_card', 'background')) {
	$sql = "ALTER TABLE " . tablename('mc_card') . " CHANGE `background` `background` VARCHAR(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '背景设置";
	pdo_query($sql);
}
//会员卡数据修复
