    ...
    else
    {
        ...
        else
        {
            if( $type == "manager" ) 
            {
                ...
                $data["store"]["sys"] = array( "title" => "商户", "items" => array( array( "title" => "用户评价", "url" => "pages/service/comment" ), array( "title" => "店铺活动", "url" => "pages/activity/index" ), array( "title" => "全部商品", "url" => "pages/goods/index" ), array( "title" => "我的资产", "url" => "pages/finance/index" ), array( "title" => "店内桌台", "url" => "pages/order/table" ), array( "title" => "排队", "url" => "pages/order/assign" ), array( "title" => "店铺推广", "url" => "pages/advertise/index" ), array( "title" => "公告列表", "url" => "pages/news/notice" ), array( "title" => "账单", "url" => "pages/paybill/index" ) ) );
