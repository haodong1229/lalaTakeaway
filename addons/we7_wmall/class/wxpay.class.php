...
class WxPay 
{
	...
	public function mktQueryBank($params) 
	{
		...
		$msg = array( "SUCCESS" => array( "errno" => 0, "text" => "该提现已成功到账", "toaccount_status" => 2 ), "PROCESSING" => array( "errno" => 0, "text" => "该提现正在处理中，请耐心等待", "toaccount_status" => 1 ), "FAILED" => array( "errno" => -1, "text" => "该提现到银行卡已失败", "toaccount_status" => 3 ), "BANK_FAIL" => array( "errno" => -1, "text" => "该提现申请银行退票", "toaccount_status" => 3 ) );
