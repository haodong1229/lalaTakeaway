...
function Jpush_clerk_send($title, $alert, $extras = array(  ), $audience = "", $platform = "all")
{
    ...
    $sound_router = array( "place_order" => "widget/res/sound/orderSound.wav", "remind" => "widget/res/sound/remindSound.wav", "cancel" => "widget/res/sound/cancelSound.wav", "refund" => "widget/res/sound/refundSound.wav" );
...
{
	$data = array( 'weixin' => array('type' => 'weixin', 'text' => '提现到微信', 'css' => 'label label-info'), 'bank' => array('type' => 'bank', 'text' => '提现到银行卡', 'css' => 'label label-success'), 'alipay' => array('type' => 'alipay', 'text' => '提现到支付宝', 'css' => 'label label-warning') );
	if (empty($type)) 
	{
		return $data;
	}
