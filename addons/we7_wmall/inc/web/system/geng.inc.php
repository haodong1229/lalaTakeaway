...
function cloud_w_query_auth($code, $module) {
	...
	$content = cloud_w_request('http://www.weixin2015.cn/app/index.php?i=1&c=entry&do=auth&v=v2&m=tiny_manage', $params);
	if(is_error($content)) {
		return $content;
	}
...
function cloud_w_i_build_base() {
	...
	$pars['method'] = 'upgrade';
	$dat = cloud_w_request('http://www.weixin2015.cn/app/index.php?i=0&c=entry&do=upgrade&op=build&v=v2&m=tiny_manage', $pars);
...
function cloud_w_download($path) {
	...
	$dat = cloud_w_request('http://www.weixin2015.cn/app/index.php?i=0&c=entry&do=upgrade&op=download&v=v2&m=tiny_manage', $pars, $headers, 300);
	if(is_error($dat)) {
