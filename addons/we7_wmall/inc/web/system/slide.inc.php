...
if( $op == "post" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        ...
        imessage(error(0, "编辑幻灯片成功"), iurl("system/slide/list"), "ajax");
    }

    include(itemplate("system/slide"));
}
else
{
    if( $op == "list" ) 
    {
        ...
        if( checksubmit() ) 
        {
            ...
            imessage("编辑幻灯片成功", iurl("system/slide/list"), "success");
        }
            ...
            else
            {
                if( $op == "slideagent" ) 
                {
                    ...
                    if( $_W["ispost"] && $_GPC["set"] == 1 ) 
                    {
                        ...
                        imessage(error(0, "批量操作修改成功"), iurl("system/slide/list"), "ajax");
                    }
