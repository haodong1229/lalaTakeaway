...
if( $ta == "post" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        ...
        $activity = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "title" => $title, "starttime" => $starttime, "endtime" => $endtime, "type" => "couponCollect", "status" => 1, "data" => iserializer($_GPC["coupons"]) );
        ...
        $coupon = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "activity_id" => $status, "title" => trim($_GPC["title"]), "starttime" => $starttime, "endtime" => $endtime, "type" => "couponCollect", "type_limit" => intval($_GPC["type_limit"]), "status" => 1, "amount" => intval($_GPC["amount"]), "coupons" => iserializer($_GPC["coupons"]) );
