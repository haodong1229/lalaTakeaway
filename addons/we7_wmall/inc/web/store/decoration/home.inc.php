...
if( $ta == "index" ) 
{
    ...
    $store_id = $sid;
    $homepage = pdo_fetch("SELECT * FROM " . tablename("tiny_wmall_store_page") . " WHERE uniacid = :uniacid and type = :type and sid = :sid", array( ":uniacid" => $_W["uniacid"], ":type" => "home", ":sid" => $store_id ));
    if( $_W["ispost"] ) 
    {
