...
if( $ta == "index" ) 
{
    ...
    if( $_GPC["r"] == "export" ) 
    {
        $stat_fields = array( "goods_title" => array( "field" => "goods_title", "title" => "商品名称", "width" => "30" ), "goods_number" => array( "field" => "goods_number", "title" => "商品编号", "width" => "20" ), "option" => array( "field" => "option", "title" => "规格", "width" => "20" ), "total_goods_num" => array( "field" => "total_goods_num", "title" => "销售量", "width" => "30" ), "total_goods_price" => array( "field" => "total_goods_price", "title" => "销售额", "width" => "20" ), "pre_goods_price" => array( "field" => "pre_goods_price", "title" => "销售额百分比", "width" => "20" ), "pre_goods_num" => array( "field" => "pre_goods_num", "title" => "销售量百分比", "width" => "20" ) );
