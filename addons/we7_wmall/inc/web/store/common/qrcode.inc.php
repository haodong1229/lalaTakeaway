...
if( $ta == "build" ) 
{
    ...
    $types = array( "store" => array( "scene_str" => "we7_wmall__store_" . $sid, "keyword" => "we7_wmall__store_" . $sid, "name" => (string) $store["title"] . "门店二维码" ), "assign" => array( "scene_str" => "we7_wmall__assign_" . $sid, "keyword" => "we7_wmall__assign_" . $sid, "name" => (string) $store["title"] . "排号二维码" ), "table" => array( "scene_str" => "we7_wmall__table_" . $sid . "_" . $table_id, "keyword" => "we7_wmall__table_" . $sid . "_" . $table_id, "name" => (string) $store["title"] . "桌台" . $table_id . "二维码" ) );
