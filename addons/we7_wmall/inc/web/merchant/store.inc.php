...
if( $op == "copy" ) 
{
    ...
    $store_account = array( "uniacid" => $_W["uniacid"], "sid" => $store_id, "fee_limit" => $config_settle["get_cash_fee_limit"], "fee_rate" => $config_settle["get_cash_fee_rate"], "fee_min" => $config_settle["get_cash_fee_min"], "fee_max" => $config_settle["get_cash_fee_max"] );
    pdo_insert("tiny_wmall_store_account", $store_account);
