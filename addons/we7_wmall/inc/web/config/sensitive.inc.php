...
if( $_W["ispost"] ) 
{
    $sensitive = array( "sensitive_words" => array(  ), "replace_words" => array(  ), "group" => array(  ) );
    ...
    if( !empty($sensitive_words) ) 
    {
        foreach( $sensitive_words as $key => $val ) 
        {
            ...
            $group[] = array( "sensitive_words" => $val, "replace_words" => $replace_words[$key] );
        }
        $sensitive = array( "sensitive_words" => $sensitive_words, "replace_words" => $replace_words, "group" => $group );
    }
