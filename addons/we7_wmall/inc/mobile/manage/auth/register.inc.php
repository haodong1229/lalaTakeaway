...
$verify = $_W["we7_wmall"]["config"]["sms"]["verify"]["clerk_register"];
if( $_W["isajax"] ) 
{
    ...
    $manager = array( "uniacid" => $_W["uniacid"], "openid" => trim($_GPC["openid"]), "mobile" => $mobile, "nickname" => trim($_GPC["nickname"]), "avatar" => trim($_GPC["avatar"]), "title" => $title, "salt" => random(6), "token" => random(32), "addtime" => TIMESTAMP );
