...
$_W["page"]["title"] = (string) $titles[$slide_type]["text"] . "推广";
if( $ta == "index" ) 
{
    if( $_W["isajax"] ) 
    {
        ...
        $update = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "type" => $slide_type, "displayorder" => 0, "title" => (string) $titles[$slide_type]["text"] . "幻灯片展示" . $day . "天", "status" => 0, "addtime" => TIMESTAMP, "starttime" => TIMESTAMP, "endtime" => TIMESTAMP, "final_fee" => $finalfee, "pay_type" => $pay_type, "days" => $day, "is_pay" => 0, "order_sn" => date("YmdHis", time()) . random(6, true), "data" => "" );
