...
if( $ta == "index" ) 
{
    if( $_W["isajax"] ) 
    {
        ...
        $recommendData = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "type" => $type, "displayorder" => 0, "title" => ($type == "recommendHome" ? "为您优选首页展示" . $day . "天" : "为您优选更多页展示" . $day . "天"), "status" => 0, "addtime" => TIMESTAMP, "endtime" => TIMESTAMP, "final_fee" => $finalfee, "pay_type" => $pay_type, "days" => $day, "is_pay" => 0, "order_sn" => date("YmdHis", time()) . random(6, true), "data" => "" );
