...
{
    $_W["page"]["title"] = "进店领券";
    $type_limit = array( array( "id" => 1, "title" => "新老用户通用" ), array( "id" => 2, "title" => "新用户" ) );
    if( $_W["isajax"] ) 
    {
        ...
        $activity = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "title" => $title, "starttime" => $starttime, "endtime" => $endtime, "type" => "couponCollect", "status" => 1, "data" => iserializer($_GPC["coupon"]) );
        ...
        $coupon = array( "uniacid" => $_W["uniacid"], "sid" => $sid, "activity_id" => $status, "title" => $activitytitle, "starttime" => $starttime, "endtime" => $endtime, "type" => "couponCollect", "type_limit" => $type_limit, "status" => 1, "amount" => $amount, "coupons" => iserializer($_GPC["coupon"]) );
