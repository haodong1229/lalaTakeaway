        ...
        else
        {
            ...
            else
            {
                if( $ta == "post" ) 
                {
                    ...
                    $result = array( "categorys" => $categorys, "goods" => $goods, "type" => $type );
                    imessage(error(0, $result), "", "ajax");
                }
