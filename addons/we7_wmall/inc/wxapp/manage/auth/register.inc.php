...
if( $_W["isajax"] ) 
{
    ...
    $manager = array( "uniacid" => $_W["uniacid"], "openid" => trim($_GPC["openid"]), "nickname" => trim($_GPC["nickname"]), "avatar" => trim($_GPC["avatar"]), "mobile" => $mobile, "title" => $title, "salt" => random(6), "token" => random(32), "addtime" => TIMESTAMP );
