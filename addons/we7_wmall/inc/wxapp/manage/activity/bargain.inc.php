...
if( $ta == "post" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        ...
        if( !empty($bargain_goods) ) 
        {
            ...
            {
                $temp = pdo_get("tiny_wmall_goods", array( "uniacid" => $_W["uniacid"], "id" => $value["id"] ), array( "id", "price" ));
                if( empty($temp) ) 
                {
                    continue;
                }
    ...
    else
    {
        ...
        else
        {
            if( $ta == "bargainList" ) 
            {
                ...
                $records = pdo_getall("tiny_wmall_activity_bargain", array( "uniacid" => $_W["uniacid"], "sid" => $sid, "status" => $status ));
                if( !empty($records) ) 
                {
