...
if( $ta == "list" ) 
{
    $condition = " as b on a.id = b.notice_id where b.uid = :uid and a.uniacid = :uniacid and type = :type and status = 1";
    $params = array( ":uniacid" => $_W["uniacid"], ":uid" => $_W["manager"]["id"], ":type" => "store" );
