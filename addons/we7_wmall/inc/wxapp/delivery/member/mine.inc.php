...
if( $ta == "index" ) 
{
    ...
    $result = array( "deliveryer" => $_W["deliveryer"], "stat" => $stat, "takeout_rank_status" => $config_delivery["extra"]["takeout_rank_status"], "errander_rank_status" => $config_delivery["extra"]["errander_rank_status"] );
