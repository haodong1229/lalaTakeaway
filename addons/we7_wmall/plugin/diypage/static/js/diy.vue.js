define(['jquery.ui'], function(ui) {
	...
	diy.init = function(params) {
		...
		diy.plugins = params.plugins;
		diy.has_gohome = diy.checkPluginExist('gohome');
		if(diy.data) {
	...
	diy.initParts = function(){
		...
		var partGroup = {
			...
			1:['fixedsearch', 'searchbar', 'navs', 'notice', 'activity', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'waimai_allstores', 'selftake_stores', 'brand_stores', 'graphic', 'listmenu', 'cart', 'redpacket', 'guide', 'service'],
			2: ['memberHeader', 'memberBindMobile', 'blockNav'],
			3: ['operation', 'info', 'tags', 'coupon', 'onsale', 'evaluate'],
			4:['fixedsearch', 'searchbar', 'navs', 'notice', 'activity', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'graphic', 'listmenu', 'cart', 'guide', 'service'],
		...
		if(diy.checkPluginExist('svip')) {
			partGroup[1].push('svipGuide');
			partGroup[2].push('svipGuide');
		}
		if(diy.has_gohome && diy.type != 2) {
			partGroup[0].push('gohomeActivity');
		}
		if(diy.has_gohome && (diy.type == 1 || diy.type == 4 || diy.type == 5)) {
			partGroup[0].push('haodianGroup');
		}
		if(diy.has_gohome && diy.type == 4) {
			partGroup[0].push('haodianSettle');
			partGroup[0].push('tongcheng');
			partGroup[0].push('tongchengStatistics');
		}
		if(diy.has_gohome && diy.type == 5) {
			partGroup[0].push('haodianList');
			partGroup[0].push('haodianSettle');
		}
	...
	diy.getParts = function(){
		diy.parts = {
			img_card: {
				name: '图片标题',
				params: {
					imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/img-card-1.jpg',
				},
			...
			banner: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/banner-1.jpg?t=1',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/banner-2.jpg',
						linkurl: '',
					}
				}
			},
			picture: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/picture-1.jpg',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/picture-2.jpg',
						linkurl: '',
					}
				},
			},
			...
			picturew: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/cube-1.jpg',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/cube-2.jpg',
						linkurl: '',
					},
					C0123456789103: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/cube-1.jpg',
			...
			navs: {
				...
				data: {
					...
					C0123456789103: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-3.png',
						linkurl: '',
						text: '导航文字3',
						color: '#666666',
					},
					C0123456789104: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-4.png',
						linkurl: '',
						text: '导航文字4',
						color: '#666666',
					}
			...
			graphic: {
				...
				data: {
					C0123456789101: {
						title: '来包香烟',
						subhead: '25分钟送达',
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-5.png',
						linkurl: '',
					},
					C0123456789102: {
						title: '生活用品',
						subhead: '25分钟送达',
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-6.png',
						linkurl: '',
					},
					C0123456789103: {
						title: '常用药品',
						subhead: '30分钟送达',
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-7.png',
						linkurl: '',
					},
					C0123456789104: {
						title: '咖啡奶茶',
						subhead: '25分钟送达',
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-8.png',
						linkurl: '',
					},
				}
			},
			notice: {
				...
				params: {
					...
					noticenum: 5,
					speed: 2,
					imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/hotdot.png',
					has_gohome: diy.has_gohome,
				},
				style: {
					paddingtop: '0',
			...
			waimai_goods: {
				...
				data: {
					C0123456789101: {
						sid: '0',
						goods_id: '0',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-1.jpg',
						price: '20.00',
						old_price: '10.00',
						title: '这里是商品标题',
						store_title: '这里是门店名称',
						...
						store: {
							id: '1',
							title: '这里是门店名称',
							logo: '../addons/we7_wmall/plugin/diypage/static/img/default/store-1.jpg',
							send_price: '15',
							delivery_price: '5',
							delivery_time: '30',
						}
					...
					C0123456789102: {
						sid: '0',
						goods_id: '0',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-2.jpg',
						price: '20.00',
						old_price: '10.00',
						title: '这里是商品标题',
						store_title: '这里是门店名称',
						...
						store: {
							id: '1',
							title: '这里是门店名称',
							logo: '../addons/we7_wmall/plugin/diypage/static/img/default/store-2.jpg',
							send_price: '15',
							delivery_price: '5',
							delivery_time: '30',
						}
					...
					C0123456789103: {
						sid: '0',
						goods_id: '0',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-3.jpg',
						price: '20.00',
						old_price: '10.00',
						title: '这里是商品标题',
						store_title: '这里是门店名称',
						...
						store: {
							id: '1',
							title: '这里是门店名称',
							logo: '../addons/we7_wmall/plugin/diypage/static/img/default/store-3.jpg',
							send_price: '15',
							delivery_price: '5',
							delivery_time: '30',
						}
					...
					C0123456789104: {
						sid: '0',
						goods_id: '0',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-4.jpg',
						price: '20.00',
						old_price: '10.00',
						title: '这里是商品标题',
						store_title: '这里是门店名称',
						...
						store: {
							id: '1',
							title: '这里是门店名称',
							logo: '../addons/we7_wmall/plugin/diypage/static/img/default/store-4.jpg',
							send_price: '15',
							delivery_price: '5',
							delivery_time: '30',
						}
				...
				data: {
					...
					C0123456789103: {
						...
						hot_goods: {
							...
							C0123456789102: {
								sid: '0',
								thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-5.jpg',
								price: '20.00',
								old_price: '10.00',
								title: '这里是商品标题',
								store_title: '这里是门店名称',
			...
			copyright: {
				name: '版权',
				params: {content: '请填写版权说明', imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/copyright.png'},
				style: {
					showimg: 1,
					style: 1,
					color: '#CECECE',
			...
			bargain: {
				...
				data: {
					C0123456789101: {
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/store-1.jpg',
						title: '水煮肉片',
						score: '5',
						discount_price: '10',
						price: '20',
					...
					C0123456789102: {
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/store-2.jpg',
						title: '青椒肉丝',
						score: '5',
						discount_price: '10',
						price: '20',
					...
					C0123456789103: {
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/store-3.jpg',
						title: '青笋肉片',
						score: '5',
						discount_price: '10',
						price: '20',
					...
					C0123456789104: {
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/store-4.jpg',
						title: '干锅鱿鱼',
						score: '5',
						discount_price: '10',
						price: '20',
			...
			operation: {
				...
				data: {
					...
					C0123456789104: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-4.png',
						linkurl: 'tangshi/pages/reserve/index?sid='+diy.store_id,
						text: '预定',
						color: '#333333',
						decoration: '点餐预定',
						dec_color: '#a0a0a0'
			...
			gohomeActivity: {
				...
				data: {
					C0123456789101: {
						...
						peoplenum: '10',
						peopleimg: {
							C0123456789101: '../addons/we7_wmall/plugin/diypage/static/img/default/store-1.jpg',
							C0123456789102: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-1.jpg',
							C0123456789103: '../addons/we7_wmall/plugin/diypage/static/img/default/store-1.jpg',
						},
					},
					C0123456789102: {
						id: 0,
			...
			tongcheng: {
				...
				data: {
					C0123456789101: {
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/member.jpg',
						tieziimg: {
							C0123456789101: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-1.jpg',
							C0123456789102: '../addons/we7_wmall/plugin/diypage/static/img/default/goods-2.jpg',
							C0123456789103: '../addons/we7_wmall/plugin/diypage/static/img/default/store-3.jpg',
							C0123456789104: '../addons/we7_wmall/plugin/diypage/static/img/default/store-4.jpg',
						}
					},
				},
				max: 1,
			...
			tongchengStatistics: {
				name: '同城统计',
				params: {
					imgurl: '../addons/we7_wmall/plugin/diypage/static/img/statistics.gif',
				},
				style: {
					margintop: '0',
			...
			haodianSettle: {
				...
				params: {
					btntext: '我要入驻',
					imgurl: '../addons/we7_wmall/plugin/diypage/static/img/new_settle.png',
				},
				style: {
					margintop: '0',
					backgroundcolor: '#ffffff',
	...
	diy.initEditor = function(scroll) {
		...
		var gohomeGoodsLength = $("#app-editor .js-selectGohomeGoods").length;
		if(gohomeGoodsLength > 0) {
			$(document).off("click", '.js-selectGohomeGoods');
			$(document).on("click", '.js-selectGohomeGoods', function() {
				diy.childid = $(this).closest('.item').data('id');
				var callback = $(this).data('callback');
				var itemid = diy.selected;
				var type = diy.items[itemid].params.type;
				var sid = diy.items[itemid].params.sid;

				irequire(["web/tiny"], function(tiny){
					tiny.selectGohomeGoods(callback, {type: type, sid: sid});
				});
			});
		}
	...
	diy.callbackGohomeGoods = function(data, option) {
		if(!data) {
			Notify.error("回调数据错误，请重试！");
			return;
		}
		...
		diy.items[itemid].data[childid] = {
			...
			title: data.name,
			discount: data.discount,
			falesailed_total: data.falesailed_total ? data.falesailed_total : data.sailed,
			sailed_percent: data.sailed_percent,
		...
		if(data.userlist && data.userlist.length > 0) {
			diy.items[itemid].data[childid].peoplenum = data.userlist.length;
			if(data.userlist[0]) {
				diy.items[itemid].data[childid].peopleimg.C0123456789101 = data.userlist[0].avatar;
			}
			if(data.userlist[1]) {
				diy.items[itemid].data[childid].peopleimg.C0123456789102 = data.userlist[1].avatar;
			}
			if(data.userlist[2]) {
				diy.items[itemid].data[childid].peopleimg.C0123456789103 = data.userlist[2].avatar;
			}
		}
		diy.initItems(itemid);
		diy.initEditor(false);
	...
	diy.checkPluginExist = function(name) {
		if(diy.plugins.indexOf(name) == -1) {
			return false;
		} else {
			return true;
		}
