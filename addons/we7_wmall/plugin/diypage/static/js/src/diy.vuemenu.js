define(['jquery.ui'], function(ui) {
		...
		if(!diyMenu.menu) {
			diyMenu.menu = {
				...
				data: {
					...
					M0123456789102: {
						img: '../addons/we7_wmall/plugin/diypage/static/img/2.png',
						link: '',
						icon: 'icon-found',
						text: '附近'
					},
					M0123456789103: {
						img: '../addons/we7_wmall/plugin/diypage/static/img/3.png',
						link: '',
						icon: 'icon-search',
						text: '搜索'
					},
					M0123456789104: {
						img: '../addons/we7_wmall/plugin/diypage/static/img/4.png',
						link: '',
						icon: 'icon-order',
						text: '订单'
					},
					M0123456789105: {
						img: '../addons/we7_wmall/plugin/diypage/static/img/5.png',
						link: '',
						icon: 'icon-mine',
						text: '我的'
					}
	...
	diyMenu.save = function () {
		$(".btn-save").unbind('click').click(function() {
		    ...
		    var posturl = "./index.php?c=site&a=entry&ctrl=diypage&ac=vuemenu&op=post&do=web&m=we7_wmall";
