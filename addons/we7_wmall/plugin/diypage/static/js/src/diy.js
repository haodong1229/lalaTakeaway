define(['jquery.ui'], function(ui) {
	...
	diy.initParts = function(){
		diy.getParts();
		var partGroup = {
			0: ['waimai_goods', 'notice', 'waimai_stores', 'img_card', 'banner', 'picture', 'picturew', 'navs', 'graphic', 'richtext', 'line', 'blank'],
		};
	...
	diy.getParts = function(){
		diy.parts = {
			...
			picturew: {
				name: '图片橱窗',
				params: {row: '1', showtype: 0},
				style: {paddingtop: '10', paddingleft: '10', showdot: 0, pagenum: '2', dotbackground: '#ff2d4b'},
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/cube-1.jpg?t=1',
						linkurl: '',
					},
					C0123456789102: {
			...
			navs: {
				name: '导航栏',
				params: {showtype: 0, showdot: 0, rownum: '4', pagenum: '8'},
				style: {
					paddingtop: '10',
					paddingleft: '10',
					navstyle: '',
			...
			notice: {
				name: '公告',
				params: {noticedata: 0, noticenum: 5, speed: 2, imgurl: '../addons/we7_wmall/plugin/diypage/static/img/default/hotdot.png'},
				style: {
					paddingtop: '10',
					paddingleft: '10',
					textcolor: '#666666',
	...
	diy.initSave = function() {
		$(".btn-save").unbind('click').click(function() {
			...
			irequire(['tiny'], function(tiny){
				$.post(tiny.getUrl('diypage/diy/post'), {id: diy.id, data: diy.data}, function(ret) {
					var ret = ret.message;
					if(ret.errno != 0) {
