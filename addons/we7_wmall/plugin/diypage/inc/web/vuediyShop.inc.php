...
if( $op == "index" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        $setting_vue = array( "use_diy_home" => intval($_GPC["vue_use_diy_home"]), "use_diy_member" => intval($_GPC["vue_use_diy_member"]), "use_diy_gohome" => intval($_GPC["vue_use_diy_gohome"]), "use_diy_tongcheng" => intval($_GPC["vue_use_diy_tongcheng"]), "use_diy_haodian" => intval($_GPC["vue_use_diy_haodian"]), "shopPage" => array_map("intval", $_GPC["vue_shopPages"]) );
        set_plugin_config("diypage.diy", $setting_vue);
        $setting_wxapp = array( "use_diy_home" => intval($_GPC["wxapp_use_diy_home"]), "use_diy_member" => intval($_GPC["wxapp_use_diy_member"]), "use_diy_gohome" => intval($_GPC["wxapp_use_diy_gohome"]), "use_diy_tongcheng" => intval($_GPC["wxapp_use_diy_tongcheng"]), "use_diy_haodian" => intval($_GPC["wxapp_use_diy_haodian"]), "shopPage" => array_map("intval", $_GPC["wxapp_shopPages"]) );
