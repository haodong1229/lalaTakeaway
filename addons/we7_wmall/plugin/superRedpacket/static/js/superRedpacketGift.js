define(['jquery.ui', 'clockpicker', 'datetimepicker'], function(ui, $) {
	...
	superRedpacket.tplEditor = function() {
		...
		$("#app-editor .category-add").unbind('click').click(function() {
			...
			if(superRedpacket.data.redpackets[itemid].scene == 'paotui') {
	...
	superRedpacket.save = function() {
		$(".btn-save").unbind('click').click(function() {
			...
			Notify.confirm('确定保存吗?', function() {
				...
				var posturl = "./index.php?c=site&a=entry&ctrl=superRedpacket&ac=gift&op=post&do=web&m=we7_wmall";
