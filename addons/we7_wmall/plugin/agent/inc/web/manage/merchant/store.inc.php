...
if( $op == "post" ) 
{
    ...
    if( $_W["ispost"] ) 
    {
        ...
        $store_account = array( "uniacid" => $_W["uniacid"], "agentid" => $_W["agentid"], "sid" => $sid, "fee_takeout" => iserializer($config_settle["fee_takeout"]), "fee_selfDelivery" => iserializer($config_settle["fee_selfDelivery"]), "fee_instore" => iserializer($config_settle["fee_instore"]), "fee_paybill" => iserializer($config_settle["fee_paybill"]), "fee_limit" => $config_settle["get_cash_fee_limit"], "fee_rate" => $config_settle["get_cash_fee_rate"], "fee_min" => $config_settle["get_cash_fee_min"], "fee_max" => $config_settle["get_cash_fee_max"] );
...
if( $op == "copy" ) 
{
    ...
    $store_account = array( "uniacid" => $_W["uniacid"], "agentid" => $_W["agentid"], "sid" => $store_id, "fee_limit" => $config_settle["get_cash_fee_limit"], "fee_rate" => $config_settle["get_cash_fee_rate"], "fee_min" => $config_settle["get_cash_fee_min"], "fee_max" => $config_settle["get_cash_fee_max"] );
    pdo_insert("tiny_wmall_store_account", $store_account);
