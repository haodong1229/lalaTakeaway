define(['jquery.ui'], function(ui) {
	...
	diy.initParts = function(){
		...
		var partGroup = {
			...
			1:['fixedsearch', 'searchbar', 'navs', 'notice', 'activity', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'waimai_allstores', 'graphic', 'listmenu', 'cart', 'redpacket', 'guide', 'service'],
		...
		diy.parts = {
			...
			notice: {
				...
				params: {
					...
					noticenum: 5,
					speed: 2,
					imgurl: '../addons/we7_wmall/plugin/wxapp/static/img/default/hotdot.png',
					has_gohome: diy.has_gohome,
				},
				style: {
					paddingtop: '0',
				...
				data: {
					...
					C0123456789104: {
						...
						store: {
							id: '1',
							title: '这里是门店名称',
							logo: '../addons/we7_wmall/plugin/wxapp/static/img/default/store-4.jpg',
							send_price: '15',
							delivery_price: '5',
							delivery_time: '30',
						}
			...
			gohomeActivity: {
				...
				data: {
					C0123456789101: {
						...
						peoplenum: '10',
						peopleimg: {
							C0123456789101: '../addons/we7_wmall/plugin/wxapp/static/img/default/store-1.jpg',
							C0123456789102: '../addons/we7_wmall/plugin/wxapp/static/img/default/goods-1.jpg',
							C0123456789103: '../addons/we7_wmall/plugin/wxapp/static/img/default/store-1.jpg',
						},
					},
					C0123456789102: {
						id: 0,
			...
			tongcheng: {
				...
				data: {
					C0123456789101: {
						thumb: '../addons/we7_wmall/plugin/wxapp/static/img/default/member.jpg',
						tieziimg: {
							C0123456789101: '../addons/we7_wmall/plugin/wxapp/static/img/default/goods-1.jpg',
							C0123456789102: '../addons/we7_wmall/plugin/wxapp/static/img/default/goods-2.jpg',
							C0123456789103: '../addons/we7_wmall/plugin/wxapp/static/img/default/store-3.jpg',
							C0123456789104: '../addons/we7_wmall/plugin/wxapp/static/img/default/store-4.jpg',
						}
					},
				}
			},
			tongchengStatistics: {
				name: '同城统计',
				params: {
					imgurl: '../addons/we7_wmall/plugin/wxapp/static/img/statistics.gif',
				},
				style: {
					margintop: '0',
			...
			haodianSettle: {
				...
				params: {
					btntext: '我要入驻',
					imgurl: '../addons/we7_wmall/plugin/wxapp/static/img/new_settle.png',
				},
				style: {
					margintop: '0',
					backgroundcolor: '#ffffff',
