...
if( $op == "index" ) 
{
	...
	$_share = array( "title" => $config_bargain["share"]["title"], "desc" => $config_bargain["share"]["desc"], "link" => ivurl("/pages/bargain/index", array( ), true), "imgUrl" => tomedia($config_bargain["share"]["imgUrl"]) );
