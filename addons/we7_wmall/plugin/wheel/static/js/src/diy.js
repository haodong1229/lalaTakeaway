define(['jquery.ui'], function(ui) {
	...
	diy.initParts = function(){
		diy.getParts();
		var partGroup = {
			0: ['fixedsearch', 'searchbar', 'title', 'navs', 'notice', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'waimai_allstores', 'img_card', 'banner', 'picture', 'picturew', 'graphic', 'listmenu', 'cart', 'redpacket', 'richtext', 'line', 'blank', 'copyright', 'buttons'],
		};
