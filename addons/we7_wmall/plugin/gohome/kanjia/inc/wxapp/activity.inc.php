    ...
    else
    {
        ...
        else
        {
            if( $op == "share" ) 
            {
                ...
                $_W["_share"] = array( "title" => "抢购进行时", "desc" => "我正在参加" . $activity["price"] . "元抢购" . $activity["name"] . "的活动，快来帮我砍价吧", "imgUrl" => $activity["thumb"], "link" => ivurl("/gohome/pages/kanjia/share", array( "activityid" => $activity["id"], "uid" => $takeinfo["uid"] ), true) );
                $sharedata = array( "title" => "抢购进行时", "desc" => "我正在参加" . $activity["price"] . "元抢购" . $activity["name"] . "的活动，快来帮我砍价吧", "imageUrl" => $activity["thumb"], "path" => "/gohome/pages/kanjia/share?activityid=" . $activity["id"] . "&uid=" . $takeinfo["uid"] );
