...
if( $op == "index" ) 
{
    ...
    $type = trim($_GPC["type"]);
    $routers = array( "pintuan" => array( "url" => "gohome/pages/pintuan/detail", "table" => "tiny_wmall_pintuan_goods" ), "kanjia" => array( "url" => "gohome/pages/kanjia/index", "table" => "tiny_wmall_kanjia" ), "seckill" => array( "url" => "gohome/pages/seckill/index", "table" => "tiny_wmall_seckill_goods" ) );
    $router = $routers[$type];
