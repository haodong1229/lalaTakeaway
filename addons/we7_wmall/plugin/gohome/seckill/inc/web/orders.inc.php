...
if( $op == "list" ) 
{
	...
	$orders = pdo_fetchall("select a.*,b.name as goods_title from " . tablename("tiny_wmall_seckill_order") . " as a left join " . tablename("tiny_wmall_seckill_goods") . " as b on a.goods_id = b.id " . $condition . " LIMIT " . ($pindex - 1) * $psize . "," . $psize, $params);
