...
if ($op == 'location') {
	...
	$points = array(
		array('latitude' => $deliveryer['location_x'], 'longitude' => $deliveryer['location_y']),
		array('latitude' => $order['accept_location_x'], 'longitude' => $order['accept_location_y'])
		);
	$markers = array();
	$markers['deliveryer'] = array(
		...
		'width'     => 40,
		'height'    => 40,
		'callout'   => array('content' => '配送员：' . $deliveryer['title'], 'color' => '#fff', 'fontSize' => 12, 'borderRadius' => 5, 'padding' => 5, 'bgColor' => '#ff244b', 'display' => 'ALWAYS', 'textAlign' => 'center')
		);
	$markers['accept'] = array(
		'iconPath'  => '/static/img/shou.png',
		'id'        => 2,
		'latitude'  => $order['accept_location_x'],
		'longitude' => $order['accept_location_y'],
		'width'     => 40,
		'height'    => 40,
		'callout'   => array('content' => '收货', 'color' => '#fff', 'fontSize' => 12, 'borderRadius' => 5, 'padding' => 5, 'bgColor' => '#ff244b', 'display' => 'ALWAYS', 'textAlign' => 'center')
		);
	...
	if (!(empty($order['buy_location_x'])) && !(empty($order['buy_location_y']))) {
		$markers['buy'] = array(
			...
			'id'        => 3,
			'latitude'  => $order['buy_location_x'],
			'longitude' => $order['buy_location_y'],
			'width'     => 40,
			'height'    => 40,
			'callout'   => array('content' => '取货', 'color' => '#fff', 'fontSize' => 12, 'borderRadius' => 5, 'padding' => 5, 'bgColor' => '#ff244b', 'display' => 'ALWAYS', 'textAlign' => 'center')
			);
