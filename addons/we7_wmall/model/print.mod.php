...
function print_add_order($printDeviceInfo = array(  ), $order = array(  ))
{
    ...
    {
        $postdata = array( "sn" => $printDeviceInfo["deviceno"], "key" => $printDeviceInfo["key"], "printContent" => implode("<BR>", $printDeviceInfo["content"]), "times" => $printDeviceInfo["times"], "backurl" => (string) $_W["siteroot"] . "addons/we7_wmall/payment/print/notify.php" );
    ...
    else
    {
        if( $printDeviceInfo["type"] == "feie_new" ) 
        {
            ...
            $postdata = array( "user" => $user, "stime" => TIMESTAMP, "sig" => $sign, "apiname" => "Open_printMsg", "sn" => $printDeviceInfo["deviceno"], "content" => implode("<BR>", $printDeviceInfo["content"]), "times" => $printDeviceInfo["times"], "backurl" => (string) $_W["siteroot"] . "addons/we7_wmall/payment/print/notify.php", "callbackurl" => (string) $_W["siteroot"] . "addons/we7_wmall/payment/print/notify.php" );
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if( $printDeviceInfo["type"] == "xixun" ) 
                                {
                                    ...
                                    $postdata = array( "dingdan" => $printDeviceInfo["content"], "dingdanID" => $order["print_sn"], "dayinjisn" => $printDeviceInfo["deviceno"], "pages" => $printDeviceInfo["times"], "replyURL" => (string) $_W["siteroot"] . "addons/we7_wmall/payment/print/notify.php" );
                                }
                                else
                                {
