...
if( !function_exists("cloud_w_build") ) 
{
	function cloud_w_build() 
	{
		...
		$pars["method"] = "upgrade";
		$dat = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=0&c=entry&do=upgrade&op=build&v=v2&m=tiny_manage", $pars);
...
function cloud_w_query_auth($code, $module) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=auth&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_plugin_auth() 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=plugin&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_build_wxapp_authorize_params($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$params = array( "url" => rtrim($_W["siteroot"], "/"), "host" => $_SERVER["HTTP_HOST"], "module" => "we7_wmall", "wxapp_type" => $wxapp_type, "plugins" => cloud_w_plugins(), "method" => "wxapp_authorize_url", "uniacid" => $uniacid, "account" => $account, "wxapp" => array( "menu" => $menus, "extPages" => $extPages, "window" => $window, "use_diy_home" => $wxapp["diy"]["use_diy_home"], "test" => $wxapp["test"], "category" => array( "first_id" => trim($_GPC["first_id"]), "second_id" => trim($_GPC["second_id"]), "third_id" => trim($_GPC["third_id"]), "first_class" => trim($_GPC["first_class"]), "second_class" => trim($_GPC["second_class"]), "third_class" => trim($_GPC["third_class"]) ) ) );
	return $params;
}
function cloud_w_get_wxapp_authorize_url($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=authorize_url&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_get_wxapp_authorize_info($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn1/app/index.php?i=1&c=entry&do=wxapp&op=info&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_bind_tester($wechatid, $wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=bind_tester&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_unbind_tester($wechatid, $wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$params["wechatid"] = $wechatid;
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=unbind_tester&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_get_tester($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=get_tester&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_commit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=commit&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_get_commit_log($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=get_commitlog&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_submit_audit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=submit_audit&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_get_category($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=get_category&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_undocodeaudit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=undocodeaudit&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_release($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=release&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_getanywxacode($path = "", $scene = "", $wxapp_type = "we7_wmall") 
{
    ...
    $params["path"] = $path;
    $params["scene"] = $scene;
	$params['access_token'] = $account_api->getAccessToken();
  
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxapp&op=getanywxacode&v=v2&m=tiny_manage", $params);
...
function cloud_w_get_wxapp_authorize_list($wxapp_type = "we7_wmall") 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxappauth&op=authorize_list&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_get_wxapp_authorize_del($ids, $wxapp_type = "we7_wmall") 
{
	...
	$content = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=1&c=entry&do=wxappauth&op=authorize_del&v=v2&m=tiny_manage", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_download($path) 
{
	...
	$dat = cloud_w_request("http://lala.weixin2015.cn/app/index.php?i=0&c=entry&do=upgrade&op=download&v=v2&m=tiny_manage", $pars, $headers, 300);
	if( is_error($dat) ) 
	{
...
function cloud_w_lala_update_url($trade) 
{
	...
	$url = "http://lala.weixin2015.cn/web/index.php?c=plugin&a=index&do=detail&id=31&auth=" . $code;
	return $url;
}
...
function cloud_store_url() 
{
	...
	$url = "http://lala.weixin2015.cn/web/index.php?c=plugin&auth=" . $code;
	return $url;
}
