...
{
	$_W["attachurl_remote"] = ($_W["setting"]["remote"]["type"] == 1 ? $_W["setting"]["remote"]["ftp"]["url"] . "/" : $_W["setting"]["remote"]["alioss"]["url"] . "/");
...
{
	$entry = array( "module" => $_GPC["m"], "do" => $_GPC["do"], "state" => $_GPC["state"], "direct" => 0 );
}
