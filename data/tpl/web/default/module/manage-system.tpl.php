...
<?php  if(!in_array($do, array('install_success', 'module_detail'))) { ?>
	...
	<form action="" method="get">
		<table class="table we7-table table-hover vertical-middle table-manage">
			...
			<tr>
				...
				<?php  if(permission_check_account_user('see_module_manage_system_welcome_support') && $_GPC['support'] == 'welcome_support') { ?><th class="text-right"></th><?php  } ?>
				<th class="text-right">
...
<div class="js-system-module-detail" ng-controller="detailCtrl" ng-cloak>
	...
	<div class="user-head-info we7-padding-bottom">
		<span class="icon pull-left" ng-if="moduleinfo.<?php echo MODULE_SUPPORT_ACCOUNT_NAME;?> == 2"><i class="wi wi-wx-apply"></i></span>
		<span class="icon pull-left" ng-if="moduleinfo.wxapp_support == 2 && moduleinfo.<?php echo MODULE_SUPPORT_ACCOUNT_NAME;?> != 2"><i class="wi wi-wxapp-apply"></i></span>
