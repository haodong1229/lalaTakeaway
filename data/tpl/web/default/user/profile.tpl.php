			...
			<tr>
				...
				<td class="table-label">
					<select class="form-control tpl-category-parent we7-select" id="category_parent" ng-model="user.welcome_link" ng-change="httpChange('welcome_link')">
						<option ng-selected ="user.welcome_link == <?php echo WELCOME_DISPLAY_TYPE;?> || user.welcome_link == ''" ng-value="<?php echo WELCOME_DISPLAY_TYPE;?>">用户欢迎页</option>
						<option ng-selected ="user.welcome_link == <?php echo PLATFORM_DISPLAY_TYPE;?>" ng-value="<?php echo PLATFORM_DISPLAY_TYPE;?>">平台</option>
					</select>
				</td>
				<td></td>
			</tr>
