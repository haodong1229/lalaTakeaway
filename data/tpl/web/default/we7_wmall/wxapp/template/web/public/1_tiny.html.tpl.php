					...
					<div class="modal-body">
						<?php  if(MODULE_FAMILY == 'wxapp') { ?>
							<div class="alert alert-warning" style="font-size: 18px">
								您当前使用的是小程序版！<br>
								<span class="text-danger" style="font-size: 22px">如果您有公众号,我们强烈建议您：先绑定公众号（因为公众号发送模版消息没有限制）</span><br>
								如果待添加的粉丝未关注公众号, 需要先关注公众号,否则会造成无法发送模板消息的问题<br>
								...
								<span class="text-danger" style="font-size: 22px">如果您没有公众号:</span><br>
