		...
		<div class="form-group" id="peerpay-container">
			...
			<div class="col-sm-9">
				<div class="help-items">
					<?php  if(!empty($wxapp_skip)) { ?>
					<?php  if(is_array($wxapp_skip)) { foreach($wxapp_skip as $item) { ?>
					<div class="input-group help-item" style="margin-bottom: 10px;">
						<div class="input-group-addon">小程序名称</div>
						<input class="form-control" type="text" value="<?php  echo $item['title'];?>" name="wxapp_skip[title][]">
						<div class="input-group-addon">小程序AppID</div>
						<input class="form-control" type="text" value="<?php  echo $item['appid'];?>" name="wxapp_skip[appid][]">
