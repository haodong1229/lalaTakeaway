		...
		<div class="tab-pane" role="tabpanel">
			<div class="panel panel-default panel-payment-switch">
				<div class="panel-body">
					...
					<div class="col-sm-2 pull-right">
						<input type="checkbox" name="wxapp_type[wechat]" value="1" class="js-switch" <?php  if(in_array('wechat', $payment['wxapp'])) { ?>checked<?php  } ?>/>
					</div>
				</div>
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="wxapp[wechat][appid]" value="<?php  echo $payment['wechat']['default']['appid'];?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">小程序AppSecret</label>
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="wxapp[wechat][appsecret]" value="<?php  echo $payment['wechat']['default']['appsecret'];?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="wxapp[wechat][mchid]" value="<?php  echo $payment['wechat']['default']['mchid'];?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<div class="input-group">
								<input type="text" class="form-control" name="wxapp[wechat][apikey]" value="<?php  echo $payment['wechat']['default']['apikey'];?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							...
							<span class="help-block">
								<?php  if(!empty($payment['wechat']['default']['apiclient_cert'])) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							...
							<span class="help-block">
								<?php  if(!empty($payment['wechat']['default']['apiclient_key'])) { ?>
									<span class="label label-success">已上传</span>
								<?php  } else { ?>
									<span class="label label-danger">未上传</span>
								<?php  } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							...
							<span class="help-block">
								<?php  if(!empty($payment['wechat']['default']['rootca'])) { ?>
									<span class="label label-success">已上传</span>
								<?php  } else { ?>
									<span class="label label-danger">未上传</span>
								<?php  } ?>
			...
			<div class="panel panel-default panel-payment-switch">
				<div class="panel-body">
					...
					<div class="col-sm-2 pull-right">
						<input type="checkbox" name="wxapp_type[credit]" value="1" class="js-switch" <?php  if(in_array('credit', $payment['wxapp'])) { ?>checked<?php  } ?>/>
					</div>
				</div>
			</div>
			<div class="panel panel-default panel-payment-switch">
				<div class="panel-body">
					...
					<div class="col-sm-2 pull-right">
						<input type="checkbox" name="wxapp_type[delivery]" value="1" class="js-switch" <?php  if(in_array('delivery', $payment['wxapp'])) { ?>checked<?php  } ?>/>
					</div>
				</div>
			</div>
			<div class="panel panel-default panel-payment-switch">
