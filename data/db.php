...
('1','1','omJNpZEhZeHj1ZxFECKkP48B5VFbk1HP','','4','we7team','','','','','','','','','0','','','1','','');
...
INSERT INTO `ims_core_attachment` VALUES ('1', '1', '1', 'weixin.png', 'images/1/2018/06/Y6zfFWc9HF9HidH3G6QDV5HTyDhl9H.png', '1', '1528167958', '', '-1');
INSERT INTO `ims_core_attachment` VALUES ('2', '1', '1', 'foot-qrcode.jpg', 'images/1/2018/06/febUcQXXx5MDBNGM18gEgx1G1BZ1Be.jpg', '1', '1528167961', '', '-1');
...
INSERT INTO `ims_core_cache` VALUES ('we7:setting', 'a:4:{s:10:\"module_ban\";a:0:{}s:14:\"module_upgrade\";a:0:{}s:7:\"cloudip\";a:2:{s:2:\"ip\";s:12:\"47.106.73.36\";s:6:\"expire\";i:1532232098;}s:4:\"site\";s:0:\"\";}');
...
CREATE TABLE `ims_mc_card` (
  ...
  `background` varchar(1000) NOT NULL DEFAULT '' COMMENT '背景设置',
...
INSERT INTO `ims_modules` VALUES (1,'basic','system','基本文字回复','1.0','和您进行简单对话','一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(2,'news','system','基本混合图文回复','1.0','为你提供生动的图文资讯','一问一答得简单对话, 但是回复内容包括图片文字等更生动的媒体内容. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的图文回复内容.','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(3,'music','system','基本音乐回复','1.0','提供语音、音乐等音频类回复','在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(4,'userapi','system','自定义接口回复','1.1','更方便的第三方接口设置','自定义接口又称第三方接口，可以让开发者更方便的接入微擎系统，高效的与微信公众平台进行对接整合。','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(5,'recharge','system','会员中心充值模块','1.0','提供会员充值功能','','WeEngine Team','http://www.we7.cc/',0,'','',0,1,0,0,'','',1,2,1,1,1,0,0,0,0),(6,'custom','system','多客服转接','1.0.0','用来接入腾讯的多客服系统','','WeEngine Team','http://bbs.we7.cc',0,'a:0:{}','a:6:{i:0;s:5:\"image\";i:1;s:5:\"voice\";i:2;s:5:\"video\";i:3;s:8:\"location\";i:4;s:4:\"link\";i:5;s:4:\"text\";}',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(7,'images','system','基本图片回复','1.0','提供图片回复','在回复规则中可选择具有图片的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝图片。','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(8,'video','system','基本视频回复','1.0','提供图片回复','在回复规则中可选择具有视频的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝视频。','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(9,'voice','system','基本语音回复','1.0','提供语音回复','在回复规则中可选择具有语音的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝语音。','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(10,'chats','system','发送客服消息','1.0','公众号可以在粉丝最后发送消息的48小时内无限制发送消息','','WeEngine Team','http://www.we7.cc/',0,'','',0,1,0,0,'','',1,2,1,1,1,0,0,0,0),(11,'wxcard','system','微信卡券回复','1.0','微信卡券回复','微信卡券回复','WeEngine Team','http://www.we7.cc/',0,'','',1,1,0,0,'','',1,2,1,1,1,0,0,0,0),(12,'store','business','站内商城','1.0','站内商城','站内商城','WeEngine Team','http://www.we7.cc/',0,'','',0,1,0,0,'','',1,2,1,1,1,0,0,0,0);
...
INSERT INTO `ims_modules_recycle` VALUES ('2', '', 'wn_storex', '2');
INSERT INTO `ims_modules_recycle` VALUES ('3', '', 'wn_storex_plugin_bargain', '2');
INSERT INTO `ims_modules_recycle` VALUES ('4', '', 'wn_storex_plugin_credit_mall', '2');
INSERT INTO `ims_modules_recycle` VALUES ('5', '', 'wn_storex_plugin_group', '2');
INSERT INTO `ims_modules_recycle` VALUES ('6', '', 'wn_storex_plugin_hotel_service', '2');
INSERT INTO `ims_modules_recycle` VALUES ('7', '', 'wn_storex_plugin_printer', '2');
INSERT INTO `ims_modules_recycle` VALUES ('8', '', 'wn_storex_plugin_sms', '2');
INSERT INTO `ims_modules_recycle` VALUES ('9', '', 'we7_coupon', '2');
...
('8','1','RubySn0w系统团队入口设置','cover','0','1','');
...
('1','default','微站默认模板','','由RubySn0w提供默认微站模板套系','胜杰工作室','http://baidu.com','1','0');
...
INSERT INTO `ims_uni_group` VALUES ('1', '0', '体验套餐服务', 'a:1:{i:0;s:10:\"we7_coupon\";}', 'N;', '0', '0');
