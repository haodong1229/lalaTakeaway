(function() {
    function n(n) {
        ...
        return function(t, e, u, i) {
            ...
            a = (o || t).length,
            c = n > 0 ? 0 : a - 1;
            return arguments.length < 3 && (u = t[o ? o[c] : c], c += n),
            r(t, e, u, o, c, a)
        }
    }
    function r(n) {
    ...
    m.each = m.forEach = function(n, r, t) {
        r = b(r, t);
        var e, u;
        if (k(n)) for (e = 0, u = n.length; e < u; e++) r(n[e], e, n);
        else {
            var i = m.keys(n);
    ...
    m.max = function(n, r, t) {
        var e, u, i = -1 / 0,
        o = -1 / 0;
        if (null == r && null != n) for (var a = 0,
        c = (n = k(n) ? n: m.values(n)).length; a < c; a++)(e = n[a]) > i && (i = e);
        else r = x(r, t),
        m.each(n,
        function(n, t, e) { ((u = r(n, t, e)) > o || u === -1 / 0 && i === -1 / 0) && (i = n, o = u)
        });
        return i
    },
    ...
    m.partition = function(n, r, t) {
        ...
        u = [];
        return m.each(n,
        function(n, t, i) { (r(n, t, i) ? e: u).push(n)
        }),
        [e, u]
    },
    ...
    m.object = function(n, r) {
        for (var t = {},
        e = 0,
        u = O(n); e < u; e++) r ? t[n[e]] = r[e] : t[n[e][0]] = n[e][1];
        return t
    },
    m.findIndex = r(1),
    m.findLastIndex = r( - 1),
    ...
    m.partial = function(n) {
        ...
        t = function() {
            for (var e = 0,
            u = r.length,
            i = Array(u), o = 0; o < u; o++) i[o] = r[o] === m ? arguments[e++] : r[o];
    ...
    m.throttle = function(n, r, t) {
        ...
        return function() {
            ...
            return e = this,
            u = arguments,
            l <= 0 || l > r ? (o && (clearTimeout(o), o = null), a = f, i = n.apply(e, u), o || (e = u = null)) : o || !1 === t.trailing || (o = setTimeout(c, l)),
            i
        }
    },
    ...
    m.compose = function() {
        ...
        return function() {
            for (var t = r,
            e = n[r].apply(this, arguments); t--;) e = n[t].call(this, e);
            return e
        }
    },
    ...
    m.invert = function(n) {
        for (var r = {},
        t = m.keys(n), e = 0, u = t.length; e < u; e++) r[n[t[e]]] = t[e];
        return r
    },
    ...
    m.template = function(n, r, t) { ! r && t && (r = t),
        r = m.defaults({},
        r, m.templateSettings);
