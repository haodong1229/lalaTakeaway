 ...
 * WeEngine is NOT a free software, it under the license terms, visited https://www.we7.cc/ for more details.
 */
...
define('APP_URL', 'https://v2.addons.we7.cc/web/');
define('APP_STORE_URL', 'https://v2.addons.we7.cc/web');
define('APP_STORE_API', 'https://v2.addons.we7.cc/api.php');
if($_GET['res']) {
	$res = $_GET['res'];
	$reses = tpl_resources();
...
if($action == 'env') {
	...
	if(version_compare(PHP_VERSION, '5.3.0') == -1) {
		...
		$ret['php']['version']['remark'] = 'PHP版本必须为 5.3.0 以上. <a href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58062">详情</a>';
	}
	...
	if($ret['php']['pdo']['ok']) {
		...
		$ret['php']['pdo']['remark'] = '您的PHP环境不支持PDO, 请开启此扩展. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58074">详情</a>';
	}
	...
	if($ret['php']['curl']['ok']) {
		...
		$ret['php']['curl']['remark'] = '您的PHP环境不支持cURL, 也不支持 allow_url_fopen, 系统无法正常运行. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58086">详情</a>';
	...
	if($ret['php']['ssl']['ok']) {
		...
		$ret['php']['ssl']['remark'] = '没有启用OpenSSL, 将无法访问公众平台的接口, 系统无法正常运行. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58109">详情</a>';
	}
	...
	if($ret['php']['gd']['ok']) {
		...
		$ret['php']['gd']['remark'] = '没有启用GD, 将无法正常上传和压缩图片, 系统无法正常运行. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58110">详情</a>';
	}
	...
	if($ret['php']['dom']['ok']) {
		...
		$ret['php']['dom']['remark'] = '没有启用DOMDocument, 将无法正常安装使用模块, 系统无法正常运行. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['php']['session']['ok'] == 0 || strtolower($ret['php']['session']['ok']) == 'off') {
		...
		$ret['php']['session']['remark'] = '系统session.auto_start开启, 将无法正常注册会员, 系统无法正常运行. <a target="_blank" href="https://bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['write']['root']['ok']) {
		...
		$ret['write']['root']['remark'] = '本地目录无法写入, 将无法使用自动更新功能, 系统无法正常运行.  <a href="https://bbs.we7.cc/">详情</a>';
	}
...
function remote_install() {
	...
	$url = 'https://v2.addons.we7.cc/gateway.php';
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="https://www.bdou.cc">官网</a></li>
					<li role="presentation"><a href="https://www.bdou.cc">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="https://www.we7.cc">关于微擎</a> &nbsp; &nbsp; <a href="https://bbs.we7.cc">微擎帮助</a> &nbsp; &nbsp; <a href="https://www.we7.cc">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="https://www.we7.cc"><b>微擎</b></a>  &copy; 2018 <a href="https://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5ddBXif"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="公众号运营交流" title="公众号运营交流"></a>
						</label>
