<?php
/**
 * [微猫源码 System] Copyright (c) 2018 
 * 微猫源码 is NOT a free software, it under the license terms, visited http://www.weixin2015.cn/ for more details.
 */

defined('IN_IA') or exit('Access Denied');

define('HTTP_X_FOR', (isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] == '443') ? 'https://' : 'http://');
define('UPDATEHOST', HTTP_X_FOR.'vip.weixin2015.cn/app/mkinstall.php');
define('AUTH_URL', HTTP_X_FOR.'vip.weixin2015.cn/api/auth_kjmod.php?__auth=');
