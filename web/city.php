...
require tcwq_ROOT . '/addons/zh_tcwq/admin/common/attachurl.php';
//echo $_W['attachurl'];die;
require tcwq_ROOT . '/addons/zh_tcwq/admin/common/bootstrap.sys.inc.php';
require tcwq_ROOT . '/addons/zh_tcwq/admin/common/template.func.php';
require tcwq_ROOT . '/addons/zh_tcwq/admin/common/common.func.php';
...
function _forward($c, $a) {
	$file = tcwq_ROOT . '/addons/zh_tcwq/admin/source/' . $c . '/' . $a . '.ctrl.php';
	//var_dump($file);die;
	return $file;
}
