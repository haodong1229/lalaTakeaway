...
(function(g) {
    function x(a, b, c) {
        for (var d = 4,
        e = []; d--;) e[d] = Math.round(b.rgba[d] + (a.rgba[d] - b.rgba[d]) * (1 - c));
        return "rgba(" + e.join(",") + ")"
    }
    var r = g.Axis,
    y = g.Chart,
    ...
    g.maps = {};
    t(r.prototype, "getSeriesExtremes",
    function(a) {
        var b = this.isXAxis,
        c, d, e = [];
        l(this.series,
        ...
        l(this.series,
        function(a, i) {
            if (a.useMapGeometry) c = Math.min(c, a[b ? "minX": "minY"]),
    ...
    t(r.prototype, "setAxisTranslation",
    function(a) {
        var b = this.chart,
        ...
        e = b.xAxis[0];
        a.call(this);
        if (b.options.chart.type === "map" && !d && e.transA !== void 0) this.transA = e.transA = Math.min(this.transA, e.transA),
        a = (e.max - e.min) / (this.max - this.min),
        e = a > c ? this: e,
        c = (e.max - e.min) * e.transA,
        e.minPixelPadding = (e.len - c) / 2
    });
    t(y.prototype, "render",
    function(a) {
        var b = this,
        c = b.options.mapNavigation;
        a.call(b);
        b.renderMapNavigation();
        c.zoomOnDoubleClick && g.addEvent(b.container, "dblclick",
        function(a) {
            b.pointer.onContainerDblClick(a)
        });
        c.zoomOnMouseWheel && g.addEvent(b.container, document.onmousewheel === void 0 ? "DOMMouseScroll": "mousewheel",
        function(a) {
    ...
    v(y.prototype, {
        renderMapNavigation: function() {
            ...
            if (b.enableButtons) for (d in c) if (c.hasOwnProperty(d)) f = p(b.buttonOptions, c[d]),
            e = a.renderer.button(f.text, 0, 0, i).attr({
                width: f.width,
                height: f.height
            }).css(f.style).add(),
            e.handler = f.onclick,
        ...
        mapZoom: function(a, b, c) {
            if (!this.isMapZooming) {
                ...
                if (e = c ? c.duration || 500 : 0) d.isMapZooming = !0,
                setTimeout(function() {
                    d.isMapZooming = !1
                },
                e);
    ...
    r = g.extendClass(s, {
        ...
        onMouseOut: function() {
            ...
            f = e && (e.duration || 500);
            if (f && c.rgba.length === 4 && d.rgba.length === 4) delete a.pointAttr[""].fill,
    ...
    k.map = g.extendClass(k.scatter, {
        ...
        init: function(a) {
            ...
            if (h = b.options.valueRanges) l(h,
            function(a) {
                f = a.from;
                i = a.to;
                e = "";
        ...
        drawLegendSymbolGradient: function(a, b) {
            ...
            b.legendSymbol = this.chart.renderer.rect(h ? f.x + f.width + c: f.x - i - c, f.y, h ? j: i, h ? i: j, 2).attr({
                zIndex: 1
            }).add(b.legendGroup);
        ...
        getBox: function(a) {
            ...
            function(a) {
                ...
                m = Number.MAX_VALUE,
                k = Number.MIN_VALUE,
                l = Number.MAX_VALUE; h--;) typeof i[h] === "number" && !isNaN(i[h]) && (j ? (g = Math.max(g, i[h]), m = Math.min(m, i[h])) : (k = Math.max(k, i[h]), l = Math.min(l, i[h])), j = !j);
                a._maxX = g;
                a._minX = m;
                a._maxY = k;
                a._minY = l;
        ...
        translate: function() {
            ...
            function(d) {
                ...
                if (typeof d.y === "number") if (d.y > c) c = d.y;
                else if (d.y < b) b = d.y
            });
