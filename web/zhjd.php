...
require dianc_ROOT . '/addons/zh_jdgjb/admin/common/attachurl.php';
//echo $_W['attachurl'];die;
require dianc_ROOT . '/addons/zh_jdgjb/admin/common/bootstrap.sys.inc.php';
require dianc_ROOT . '/addons/zh_jdgjb/admin/common/template.func.php';
require dianc_ROOT . '/addons/zh_jdgjb/admin/common/common.func.php';
$urls = parse_url($_W['siteroot']);
$arr = explode('/', $urls['path']);
$controller =  !empty($_GPC['c']) ? $_GPC['c'] : 'user';
$action =  !empty($_GPC['a']) ? $_GPC['a'] : 'login';
...
$_W['page']['copyright'] = $_W['setting']['copyright'];
	/*echo 232;
	var_dump($acl[$controller]['direct']);die;*/
//进入登入页面
...
function _forward($c, $a) {
	$file = dianc_ROOT . '/addons/zh_jdgjb/admin/source/' . $c . '/' . $a . '.ctrl.php';
	//var_dump($file);die;
	return $file;
}
