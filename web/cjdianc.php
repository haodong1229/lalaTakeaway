...
require dianc_ROOT . '/addons/zh_cjdianc/admin/common/attachurl.php';
//echo $_W['attachurl'];die;
require dianc_ROOT . '/addons/zh_cjdianc/admin/common/bootstrap.sys.inc.php';
require dianc_ROOT . '/addons/zh_cjdianc/admin/common/template.func.php';
require dianc_ROOT . '/addons/zh_cjdianc/admin/common/common.func.php';
...
function _forward($c, $a) {
	$file = dianc_ROOT . '/addons/zh_cjdianc/admin/source/' . $c . '/' . $a . '.ctrl.php';
	//var_dump($file);die;
	return $file;
}
